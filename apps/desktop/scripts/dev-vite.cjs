 ...
 * Sets NESTCAFE_ROUTER_URL environment variable and starts Vite.
 *
...
process.env.NESTCAFE_ROUTER_URL = 'http://localhost:5173';
...
console.log('[dev-vite] Starting Vite with NESTCAFE_ROUTER_URL=http://localhost:5173');
