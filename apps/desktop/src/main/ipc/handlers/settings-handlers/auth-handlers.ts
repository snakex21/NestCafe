...
import { validateHttpUrl } from '@nestcafe_ai/agent-core/desktop-main';
import { getSlackMcpOauthStatus } from '@nestcafe_ai/agent-core/desktop-main';
...
export function registerAuthHandlers(handle: IpcHandler): void {
  ...
  handle('opencode:auth:openai:login', async (_event: IpcMainInvokeEvent) => {
    ...
    // apps/desktop/src/preload/index.ts and apps/web/src/client/lib/nestcafe.ts.
