...
describe('Preload Script Integration', () => {
  ...
  describe('IPC Method Invocations', () => {
    ...
    describe('Task Operations', () => {
      ...
      it('interruptTask should invoke task:interrupt with taskId', async () => {
        await (capturedNestCafeAPI.interruptTask as (taskId: string) => Promise<void>)(
          'task_123',
        );
      ...
      it('removeFavorite should invoke favorites:remove with taskId', async () => {
        await (capturedNestCafeAPI.removeFavorite as (taskId: string) => Promise<void>)(
          'task_123',
        );
      ...
      it('isFavorite should invoke favorites:has with taskId', async () => {
        await (capturedNestCafeAPI.isFavorite as (taskId: string) => Promise<boolean>)(
          'task_123',
        );
    ...
    describe('API Key Operations', () => {
      ...
      it('validateApiKey should invoke api-key:validate', async () => {
        await (capturedNestCafeAPI.validateApiKey as (key: string) => Promise<unknown>)(
          'sk-test',
        );
  ...
  describe('Event Subscriptions', () => {
    ...
    it('onTaskUpdateBatch should subscribe to task:update:batch', () => {
      const callback = vi.fn();
      (capturedNestCafeAPI.onTaskUpdateBatch as (cb: (e: unknown) => void) => () => void)(
        callback,
      );
