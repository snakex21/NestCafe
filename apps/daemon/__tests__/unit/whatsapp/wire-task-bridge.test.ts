...
vi.mock('@nestcafe_ai/agent-core', async () => {
  const actual = await vi.importActual<typeof import('@nestcafe_ai/agent-core')>(
...
// from `@nestcafe_ai/agent-core/common/types/permission`; wireTaskBridge
