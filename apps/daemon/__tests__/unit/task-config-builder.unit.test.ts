...
vi.mock('@nestcafe_ai/agent-core/storage/database', () => ({
...
vi.mock('@nestcafe_ai/agent-core/storage/repositories/knowledgeNotes', () => ({
...
// pulls in via that barrel. The vitest alias maps `@nestcafe_ai/agent-core`
// to agent-core's src/, so the relative path resolves the same way as from
// `src/opencode/config-builder.ts`.
vi.mock('@nestcafe_ai/agent-core/storage/repositories/index', async () => {
  return {
