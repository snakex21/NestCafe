...
import { testAzureFoundryConnection, validateHttpUrl } from '@nestcafe_ai/agent-core/desktop-main';
import type { AzureFoundryConfig } from '@nestcafe_ai/agent-core/desktop-main';
