...
import { fetchOpenRouterModels, fetchProviderModels } from '@nestcafe_ai/agent-core/desktop-main';
import { DEFAULT_PROVIDERS, ZAI_ENDPOINTS } from '@nestcafe_ai/agent-core/desktop-main';
import type { ZaiRegion } from '@nestcafe_ai/agent-core/desktop-main';
