...
import { discoverOAuthMetadata, refreshAccessToken } from '@nestcafe_ai/agent-core/desktop-main';
import type { OAuthProviderId, ConnectorDesktopOAuthKind } from '@nestcafe_ai/agent-core/common';
import { getConnectorDefinition } from '@nestcafe_ai/agent-core/common';
