...
import { validateVertexCredentials, fetchVertexModels } from '@nestcafe_ai/agent-core/desktop-main';
import type { VertexCredentials } from '@nestcafe_ai/agent-core/desktop-main';
