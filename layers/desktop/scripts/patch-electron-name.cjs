 ...
 * - Registers the "nestcafe://" URL scheme so OAuth callbacks route to the running dev instance
 */
const fs = require('fs');
const path = require('path');

const APP_NAME = 'NestCafe';
const URL_SCHEME = 'nestcafe';
...
// Add CFBundleURLTypes for the nestcafe:// protocol (if not already present)
