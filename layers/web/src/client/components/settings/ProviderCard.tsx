...
import { isProviderReady } from '@nestcafe_ai/agent-core/common';
...
export const ProviderCard = memo(function ProviderCard({
  ...
  // For custom providers, use custom icon and name from credentials
  const customCredentials =
    providerId.startsWith('custom:') && connectedProvider?.credentials.type === 'custom'
      ? connectedProvider.credentials
      : undefined;
  const logoSrc = customCredentials?.iconUrl || PROVIDER_LOGOS[providerId] || PROVIDER_LOGOS.custom;
