...
export const ExecutionHeader = memo(function ExecutionHeader({ prompt, status }: { prompt: string; status: TaskStatus }) {
  const navigate = useNavigate();

  return (
    <div className="flex-shrink-0 border-b border-border bg-card/50 px-6 py-4" data-testid="execution-header">
