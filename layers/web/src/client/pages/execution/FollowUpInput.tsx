...
import type { FileAttachmentInfo, Task } from '@nestcafe_ai/agent-core';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto space-y-2">
        ...
        <div className="rounded-xl border border-border bg-background shadow-sm transition-[border-color,box-shadow] duration-200 focus-within:border-ring focus-within:ring-1 focus-within:ring-ring">
