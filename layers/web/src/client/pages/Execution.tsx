...
export default function ExecutionPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-background relative" style={{ contain: 'layout style' }}>
      ...
      {/* Queued state — animated transition between empty and with-messages */}
      ...
      {/* Follow-up input — animated entrance */}
      <AnimatePresence>
        {s.canFollowUp && (
          <motion.div
            key="follow-up"
