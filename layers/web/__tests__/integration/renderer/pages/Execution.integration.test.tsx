...
import type { Task, TaskStatus, TaskMessage, PermissionRequest } from '@nestcafe_ai/agent-core';
import { OAuthProviderId, PROMPT_DEFAULT_MAX_LENGTH } from '@nestcafe_ai/agent-core/common';
...
vi.mock('@/lib/nestcafe', () => ({
  getNestCafe: () => mockAccomplish,
}));
...
describe('Execution Page Integration', () => {
  beforeEach(() => {
    ...
    (window as Window & { nestcafe: typeof mockAccomplish }).accomplish = mockAccomplish;
    // Reset store state
    mockStoreState = {
      currentTask: null,
      loadTaskById: mockLoadTaskById,
