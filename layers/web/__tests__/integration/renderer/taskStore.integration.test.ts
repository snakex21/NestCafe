 ...
 * Tests store actions with mocked window.nestcafe API
 * @module __tests__/integration/renderer/taskStore.integration.test
 */

import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { STARTUP_STAGES } from '@nestcafe_ai/agent-core/common';
import type {
  Task,
  TaskConfig,
  TaskStatus,
...
// Mock window.nestcafe for global subscriptions
      ...
      useTaskStore.setState({
        ...
        permissionRequests: {
          'task-1': {
            ...
            taskId: 'task-1',
            type: 'file',
          } as import('@nestcafe_ai/agent-core/common').PermissionRequest,
          'task-2': {
            id: 'perm-2',
            taskId: 'task-2',
            type: 'file',
