...
export interface StorageOptions {
   ...
   * `nestcafe.db`; after successful import the deletion helper uses the
...
export type LanguagePreference = 'auto' | 'en' | 'zh-CN' | 'ru' | 'fr' | 'pl';
...
/** A single result from a full-text search across conversation history. */
...
export interface TaskStorageAPI {
  ...
  /** Full-text search across task message history using FTS5 */
  searchConversations(query: string, limit?: number): ConversationSearchResult[];
}

/** API for module management */
export interface ModuleStorageAPI {
  /** List all installed modules */
  listModules(): import('../common/types/module.js').ModuleInstance[];
  /** Get a module by ID */
  getModule(id: string): import('../common/types/module.js').ModuleInstance | undefined;
  /** Get a module by name */
  getModuleByName(name: string): import('../common/types/module.js').ModuleInstance | undefined;
  /** Install a new module from manifest and paths */
  installModule(
    manifest: import('../common/types/module.js').ModuleManifest,
    sourcePath: string,
    entryPath: string,
  ): import('../common/types/module.js').ModuleInstance;
  /** Enable or disable a module */
  enableModule(id: string, enabled: boolean): void;
  /** Uninstall (delete) a module */
  uninstallModule(id: string): void;
  /** Get a single module setting value */
  getModuleSetting(moduleId: string, key: string): string | undefined;
  /** Set a module setting value */
  setModuleSetting(moduleId: string, key: string, value: string): void;
  /** Delete a module setting */
  deleteModuleSetting(moduleId: string, key: string): void;
...
export interface AppSettingsAPI {
  ...
  /** Get the folder indexing configuration */
...
export interface ProviderSettingsAPI {
  ...
  getNestCafeAiCredits(): CreditUsage | null;
  /** Cache Accomplish AI credit usage */
  saveNestcafeAiCredits(usage: CreditUsage): void;
}
