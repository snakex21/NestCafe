...
import { getFolderIndexingConfig as _getFolderIndexingConfig } from './folder-indexing-settings.js';
import type { FolderIndexingConfig } from '../../common/types/folder-indexing.js';

export type { CloseBehavior } from './ui-settings.js';
export { getFolderIndexingConfig, setFolderIndexingConfig } from './folder-indexing-settings.js';
