/**
 * NestcafeRuntime — adapter interface for the Accomplish AI free-tier gateway.
 *
 * OSS ships a noop implementation. The real implementation lives in the private
 * @nestcafe/llm-gateway-client package and is injected at daemon startup via
 * dynamic import.
 *
...
export interface NestcafeRuntime {
...
const UNAVAILABLE_ERROR = 'NESTCAFE_runtime_unavailable';

export const noopRuntime: NestcafeRuntime = {
  connect: async () => {
