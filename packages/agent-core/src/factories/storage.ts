...
import {
  ...
  getSandboxConfig,
  setSandboxConfig,
  getFolderIndexingConfig,
  setFolderIndexingConfig,
...
import {
  ...
  getNestCafeAiCredits,
  saveNestcafeAiCredits,
...
import {
  ...
  deleteModuleSetting,
  getModuleSettings,
} from '../storage/repositories/modules.js';
...
export function createStorage(options: StorageOptions = {}): StorageAPI {
  const {
    ...
    runMigrations = true,
    userDataPath,
    secureStorageAppId = 'ai.nestcafe.desktop',
  ...
  return {
    ...
    searchConversations: (query, limit) => searchConversations(query, limit),
    ...
    getFolderIndexingConfig: () => getFolderIndexingConfig(),
    setFolderIndexingConfig: (config) => setFolderIndexingConfig(config),
    ...
    getNestCafeAiCredits: () => getNestCafeAiCredits(),
    saveNestcafeAiCredits: (usage) => saveNestcafeAiCredits(usage),
    ...
    getModule: (id) => getModule(id),
    getModuleByName: (name) => getModuleByName(name),
    installModule: (manifest, sourcePath, entryPath) =>
      installModule(manifest, sourcePath, entryPath),
    enableModule: (id, enabled) => enableModule(id, enabled),
    uninstallModule: (id) => uninstallModule(id),
    getModuleSetting: (moduleId, key) => getModuleSetting(moduleId, key),
    setModuleSetting: (moduleId, key, value) => setModuleSetting(moduleId, key, value),
    deleteModuleSetting: (moduleId, key) => deleteModuleSetting(moduleId, key),
    getModuleSettings: (moduleId) => getModuleSettings(moduleId),
