// =============================================================================
// @nestcafe/core - Public API (v0.4.0)
// =============================================================================
// This file explicitly exports the public API for the @nestcafe/core package.
...
export { generateConfig, NESTCAFE_AGENT_NAME } from './opencode/config-generator.js';
...
export { noopRuntime } from './opencode/nestcafe-runtime.js';
export type {
  NestcafeRuntime,
...
export { getDatabase, getDatabasePath } from './storage/index.js';
...
// in the main `nestcafe.db` per v030; this helper deletes the retired
...
// Module system
export { discoverModules, getDefaultModuleDirs } from './modules/index.js';
export type { DiscoveredModule } from './modules/index.js';
...
// -----------------------------------------------------------------------------
// Shared Module (from ./common/) - Merged from @nestcafe/shared
// -----------------------------------------------------------------------------

// Task types
// Messaging integration types
export type { MessagingConnectionStatus } from './common/types/messaging.js';
...
// Module system types
export type { ModuleManifest, ModuleInstance } from './common/types/module.js';
...
export type {
  ...
  FileTypeCounts,
  FileCategory,
} from './common/types/folder-indexing.js';
export {
  EXT_CATEGORY_MAP,
