...
graph TD
  subgraph MONOREPO["Accomplish Monorepo (pnpm workspaces)"]
    ...
    DESKTOP["@nestcafe/desktop<br/><i>Electron app · v0.3.8</i><br/>apps/desktop/"]
    WEB["@nestcafe/web<br/><i>React UI · v0.0.1</i><br/>apps/web/"]
    CORE["@nestcafe_ai/agent-core<br/><i>Shared library · v0.4.0</i><br/>packages/agent-core/"]
...
| **Apps**             | `@nestcafe/desktop` (Electron 35), `@nestcafe/web` (React 19)   |
| **Shared library**   | `@nestcafe_ai/agent-core` (TypeScript ESM)                        |
