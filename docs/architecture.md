...
packages/agent-core/     # Core business logic, shared types, MCP tools (published as @nestcafe_ai/agent-core)
```

- `index.ts` - Electron bootstrap, single-instance enforcement, `nestcafe://` protocol handler
