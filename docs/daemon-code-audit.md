...
**Nobody starts it.** The Electron app does not depend on `@nestcafe/daemon`, does not import from it, and does not spawn it. It exists as an independent workspace package but has no integration point.
